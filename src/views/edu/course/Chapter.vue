<template>
  <div class="app-container">
    ...
    <el-form :model="chapter" label-width="120px"> <el-form-item label="章节标题">
...
export default {
  ...
  methods: {
    ...
    //上传之前调用的方法
    handleUploadExceed(){
        return this.$message.warning('想要重新上传视频，请先删除已上传的视频')
    },
...
//-----------------------------------------章节操作-----------------------------------------------
      ...
      openEditChapter(chapterId){
          ...
          //调用接口
          chapter.getChapterById(chapterId).then(
              response=>{
